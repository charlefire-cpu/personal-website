...
export function ArrowDownTrayIcon({ className = 'h-4 w-4', ...props }: IconProps) {
  return (
    <svg className={className} {...defaults} {...props}>
      <path
        strokeLinecap="round"
...
export function ClipboardListIcon({ className = 'h-5 w-5', ...props }: IconProps) {
  return (
    <svg className={className} {...defaults} {...props}>
      <path
        strokeLinecap="round"
...
export function CodeBracketIcon({ className = 'h-5 w-5', ...props }: IconProps) {
  return (
    <svg className={className} {...defaults} {...props}>
      <path
        strokeLinecap="round"
...
export function BeakerIcon({ className = 'h-5 w-5', ...props }: IconProps) {
  return (
    <svg className={className} {...defaults} {...props}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 0 1 4.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0 1 12 15a9.065 9.065 0 0 0-6.23.693L5 14.5m14.8 0 .665 1.665A2.25 2.25 0 0 1 18 19.5H6a2.25 2.25 0 0 1-2.165-2.835L4.2 15.3"
      />
    </svg>
  )
}

export function RocketLaunchIcon({ className = 'h-5 w-5', ...props }: IconProps) {
  return (
    <svg className={className} {...defaults} {...props}>
      <path
        strokeLinecap="round"
